...
public class HttpClientHelper {
	...
	public static String requestBodyString(String urlToRequest, Map<String, String> parameters) {
		return convertStreamToString(invokeRequest(urlToRequest, REQUEST_METHOD.GET, parameters),
				"utf-8");
	}

	public static String postBodyString(String urlToRequest, Map<String, String> parameters) {
		return convertStreamToString(invokeRequest(urlToRequest, REQUEST_METHOD.POST, parameters),
				"utf-8");
	}

	public static InputStream invokeRequest(String urlToRequest, REQUEST_METHOD method,
