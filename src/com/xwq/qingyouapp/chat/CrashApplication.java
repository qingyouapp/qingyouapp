...
//        result.putString(RES_EMAIL_SUBJECT, mContext.getResources().getText(R.string.chat_mobosquare_email_subject).toString());
//        result.putString(RES_EMAIL_TEXT, mContext.getResources().getText(R.string.chat_mobosquare_email_text).toString());
//        result.putString(RES_DIALOG_TITLE, mContext.getResources().getText(R.string.chat_mobosquare_dialog_title).toString());
//        result.putString(RES_DIALOG_TEXT, mContext.getResources().getText(R.string.chat_mobosquare_dialog_text).toString());
//        result.putString(RES_BUTTON_REPORT, mContext.getResources().getText(R.string.chat_mobosquare_report).toString());
//        result.putString(RES_BUTTON_CANCEL, mContext.getResources().getText(R.string.chat_mobosquare_exit).toString());
//        //Hide restart button
