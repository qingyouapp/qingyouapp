...
public class GroupMemberAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (u.getName().equals("")) {
			icon.setImageResource(R.drawable.chat_add_member);
			layout.addView(icon, (int) (density * 60), (int) (60 * density));
		} else {
			icon.setImageResource(R.drawable.chat_head_icon_user);
			icon.setId(arg0 + 1);
			layout.addView(icon, (int) (density * 60), (int) (60 * density));
			...
			if (deleteFlag) {
				if (!u.getName().equals(currentLoginName)) {
					...
					param.addRule(RelativeLayout.ALIGN_PARENT_TOP,
							RelativeLayout.TRUE);
					deleteIcon.setImageResource(R.drawable.chat_del_flag);
